    ...
    <div class="d-flex justify-content-center">
      <div class="sign-up-frame">
        ...
        <form @submit.prevent="processForm">
          ...
          <!-- Token/Phone -->
          <div class="form-group">
            <label for="inputTokenPhone">Customer Phone Number</label>
            <b-form-input
              class="form-group"
          ...
          <div class="form-group" v-if="this.selectedOperation==='cash-to-cash'">
            <label for="inputRecipientPhone">Recipient Phone Number</label>
            <b-form-input
              class="form-group"
    ...
    async processForm(e) {
      try {
        ...
        if (!this.customerIdentifier) {
          this.errors.inputTokenPhone = 'Customer Mobile required.';
          errorFlag = true;
        }
        ...
        if (!errorFlag && this.customerIdentifier && this.amount && this.selectedOperation) {
          ...
          await this.axios.post(process.env.VUE_APP_PROXY_API_URL + '/webSiteCashInOutOrange', postData, {
            headers: {
